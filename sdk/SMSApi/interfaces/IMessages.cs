...
namespace InteractuaMovil.ContactoSms.Api.interfaces
{
    public interface IMessages
    {
        ...
        ResponseObjects.ApiResponse<ResponseObjects.MessageToGroupResponse> SendToGroups(String[] ShortName, String Message, String Id = null);
        ResponseObjects.ApiResponse<ResponseObjects.MessageToGroupResponse> SendToContact(String Msisdn, String Message, String Id = null);
